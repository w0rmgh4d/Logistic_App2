    ...
    NavHost(
        ...
        composable(Screen.Emergency.route) {
            EmergencyScreen(
                ...
                onBack = { navController.popBackStack() },
                onForwardToChat = {
                    // Navigate to emergency chat and REMOVE the emergency reporting screens from stack
        ...
        composable("emergency_chat/{reportId}") { backStackEntry ->
            ...
            ChatScreen(
                ...
                documentId = reportId,
                onBack = {
                    // When leaving resolved emergency chat, explicitly return to Dashboard
                    navController.navigate(Screen.Dispatch.route) {
                        popUpTo(0) { inclusive = true }
                    }
                }
